...
__all__ = [
    'STSF_AppData', 'DISPIDSPTSI_SelectionOffset', 'SpCustomStream',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SDTPronunciation',
    'SpeechGrammarTagUnlimitedDictation', 'SpeechAllElements',
    'SPCATEGORYTYPE', 'SBONone', 'DISPID_SPIEnginePrivateData',
    'SPAS_PAUSE', 'DISPID_SVWaitUntilDone', 'SpeechEngineProperties',
    'SpNullPhoneConverter', 'SPCS_ENABLED',
    'ISpeechGrammarRuleStateTransition',
    'DISPIDSPTSI_SelectionLength', 'eLEXTYPE_PRIVATE20',
    'SpeechEmulationCompareFlags', 'DISPID_SRCRetainedAudioFormat',
    'SDKLLocalMachine', 'DISPID_SRCESoundEnd', 'SAFT32kHz16BitStereo',
    'DISPID_SPIElements', 'SRAONone',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SPEAudioSizeTime', 'DISPID_SOTDisplayUI',
    'DISPID_SWFEBitsPerSample', 'SVP_19', 'SPVPRI_ALERT',
    'SDA_Two_Trailing_Spaces', 'DISPID_SpeechVoiceStatus',
    'SPSModifier', 'ISpAudio', 'DISPID_SRRAlternates',
    'SpeechStreamFileMode', 'DISPID_SDKEnumKeys',
    'ISpeechResourceLoader', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SpeechObjectTokens', 'SSSPTRelativeToStart',
    'SAFT12kHz8BitMono', 'SP_VISEME_14', 'DISPID_SRSClsidEngine',
    'SPINTERFERENCE_TOOFAST', 'SVP_15', 'SPEI_RECOGNITION',
    'SRADefaultToActive', 'SpeechVoiceEvents', 'SpMMAudioEnum',
    'SVSFUnusedFlags', 'DISPID_SRCSetAdaptationData',
    'SPEI_VOICE_CHANGE', 'SPSERIALIZEDRESULT',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SPRuleFirstElement', 'eLEXTYPE_USER', 'DISPID_SBSFormat',
    'DISPID_SPIReplacements', 'SVP_4', 'SAFT24kHz8BitStereo',
    'DISPID_SPIRetainedSizeBytes', 'SSSPTRelativeToCurrentPosition',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPEActualConfidence',
    'SFTSREngine', 'SDTRule', 'SAFTCCITT_ALaw_11kHzStereo',
    'SDA_No_Trailing_Space', 'SpWaveFormatEx', 'SRERecoOtherContext',
    'DISPID_SPRulesItem', 'SINone', 'SP_VISEME_15',
    'DISPID_SOTDataKey', 'DISPID_SOTSetId', 'ISpeechFileStream',
    'SREStreamEnd', 'SRTSMLTimeout', 'DISPID_SPERetainedStreamOffset',
    'SpeechGrammarTagDictation', 'ISpeechLexiconWord',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'eLEXTYPE_PRIVATE19',
    'DISPID_SMSAMMHandle', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRGIsPronounceable', 'DISPID_SLPPhoneIds',
    'ISpStreamFormat', 'SpeechCategoryAudioIn',
    'DISPID_SpeechXMLRecoResult', 'SVF_Emphasis', 'SPAR_Medium',
    'DISPID_SVAudioOutputStream',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SLPsCount',
    'SAFT8kHz16BitMono', 'DISPID_SOTCDefault', 'SAFTNoAssignedFormat',
    'SRTAutopause', 'DISPID_SPEPronunciation', 'SRCS_Disabled',
    'SpeechPropertyComplexResponseSpeed', 'LONG_PTR',
    'SPPS_NotOverriden', 'DISPID_SWFEFormatTag',
    'DISPID_SVEAudioLevel', 'SAFTNonStandardFormat',
    'eLEXTYPE_RESERVED6', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'ISpXMLRecoResult', 'SpeechRetainedAudioOptions', 'SPEI_VISEME',
    'DISPID_SVGetVoices', 'SPEVENTSOURCEINFO', 'DISPIDSPRG',
    'DISPID_SMSADeviceId', 'ISpRecoGrammar2', 'SDKLDefaultLocation',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRRTTickCount',
    'SVSFIsFilename', 'SVP_3', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRRAudio', 'DISPID_SVSLastBookmarkId',
    'SPINTERFERENCE_NONE', 'STSF_LocalAppData', 'SVP_21',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SOTGetDescription',
    'eLEXTYPE_PRIVATE4', 'SpeechRecoContextState',
    'ISpeechPhraseAlternate', 'SPRST_NUM_STATES',
    'SPSEMANTICERRORINFO', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SpeechRecoContextEvents', 'SWTAdded',
    'SAFT12kHz16BitStereo', 'DISPID_SRRecognizer',
    'SAFTExtendedAudioFormat', 'ISpeechAudioBufferInfo',
    'SpPhoneConverter', 'SPLO_DYNAMIC', 'eLEXTYPE_PRIVATE1',
    'SAFT16kHz8BitMono', 'DISPID_SVEBookmark', 'DISPID_SRCPause',
    'tagSTATSTG', 'DISPID_SRCEPhraseStart', 'DISPID_SPPsCount',
    'SRSEDone', 'SPPHRASE', 'DISPID_SLWType', 'ISpLexicon',
    'SAFTADPCM_44kHzMono', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPRuleParent', 'SINoSignal',
    'DISPID_SOTMatchesAttributes', 'ISpeechObjectTokenCategory',
    'SP_VISEME_8', 'SREHypothesis', 'SPPS_Verb', 'DISPID_SGRName',
    'SAFT24kHz8BitMono', 'SVP_12', 'SPDATAKEYLOCATION',
    'DISPID_SGRSTPropertyValue', 'DISPID_SDKCreateKey',
    'DISPID_SDKSetStringValue', 'ISpeechRecoResult',
    'DISPID_SVEStreamStart', 'DISPID_SRStatus', 'SPEI_RESERVED2',
    'SP_VISEME_20', 'SAFTText', 'ISpeechPhraseReplacements',
    'SPEI_PHONEME', 'SpShortcut', 'SpStream',
    'SpeechAudioFormatGUIDWave', 'DISPID_SPAStartElementInResult',
    'SpeechSpecialTransitionType', 'SP_VISEME_1', 'SPRS_INACTIVE',
    'SpObjectTokenCategory', 'SPEI_MIN_SR', 'SVSFPurgeBeforeSpeak',
    'SAFTADPCM_44kHzStereo', 'SpeechVoicePriority',
    'DISPID_SABIMinNotification', 'DISPID_SRCEFalseRecognition',
    'DISPID_SPPNumberOfElements', 'SVEBookmark', 'SGRSTTRule',
    'SAFT12kHz16BitMono', 'SREFalseRecognition',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRGState',
    'SpResourceManager', 'DISPID_SRCEStartStream',
    'DISPID_SRSetPropertyString', 'SECFIgnoreCase',
    'SAFT12kHz8BitStereo', 'DISPID_SCSBaseStream',
    'SPRECORESULTTIMES', 'ISpeechPhraseReplacement',
    'SPWORDPRONUNCIATIONLIST', 'SAFT11kHz16BitMono',
    'DISPID_SOTs_NewEnum', 'ISpeechPhraseInfo', 'SPBO_AHEAD',
    'SPSHT_NotOverriden', 'eLEXTYPE_VENDORLEXICON',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SRCVoicePurgeEvent', 'STCAll',
    'SpUnCompressedLexicon', 'DISPID_SAEventHandle', 'SVP_18',
    'SVP_13', 'DISPID_SRRGetXMLResult', 'SAFTCCITT_ALaw_22kHzMono',
    'SRSActiveAlways', 'SAFT16kHz8BitStereo', 'DISPID_SPPConfidence',
    'DISPID_SWFEAvgBytesPerSec',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SGRsCount',
    'DISPID_SPAsItem', 'SpeechVoiceSkipTypeSentence', 'ISpEventSink',
    'DISPID_SpeechPhraseInfo', 'SPSHT_EMAIL', 'SPSEMANTICFORMAT',
    'SPEI_SENTENCE_BOUNDARY', 'SPEI_END_INPUT_STREAM', 'DISPID_SOTId',
    'SPAUDIOSTATUS', 'SpCompressedLexicon', 'ISpeechRecoGrammar',
    'SpeechWordPronounceable', 'SAFTGSM610_22kHzMono',
    'DISPID_SpeechPhraseRule', 'SpeechTokenIdUserLexicon',
    'SRAExport', 'SVEPhoneme', 'SSFMOpenForRead',
    'ISpeechGrammarRuleStateTransitions', 'SGRSTTDictation',
    'DISPID_SPRs_NewEnum', 'SP_VISEME_19',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPBO_TIME_UNITS',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SOTIsUISupported',
    'SPEVENTENUM', 'SAFTDefault', 'SpObjectToken',
    'DISPID_SMSSetData', 'SPRST_INACTIVE_WITH_PURGE', 'SVP_10',
    'SWPUnknownWordPronounceable', 'SPEI_REQUEST_UI',
    'DISPID_SRRSpeakAudio', 'SpeechAddRemoveWord', 'SpMemoryStream',
    'DISPID_SRCBookmark', 'SPWORDPRONUNCIATION',
    'DISPID_SPIGetDisplayAttributes', 'SPSNoun', 'DISPID_SRDisplayUI',
    'DISPID_SPARecoResult', 'SPPHRASERULE', 'SPCT_COMMAND',
    'SPFM_CREATE', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFTADPCM_11kHzStereo', 'DISPID_SPEAudioSizeBytes',
    'SPRS_ACTIVE', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPEDisplayAttributes', 'SPGRAMMARWORDTYPE',
    'ISpRecoGrammar', 'DISPID_SRCEBookmark',
    'DISPID_SpeechPhraseReplacements', 'SPEI_SR_RETAINEDAUDIO',
    'SBOPause', 'SAFTADPCM_11kHzMono', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPAR_High', 'SECFNoSpecialChars', 'DISPID_SAFGuid',
    'SREAudioLevel', 'SVP_14', 'SpInProcRecoContext',
    'SPXMLRESULTOPTIONS', 'SPRULE', 'DISPID_SADefaultFormat',
    'DISPID_SRAudioInputStream', 'SITooFast', 'SAFT22kHz16BitStereo',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRCVoice',
    'DISPID_SDKDeleteValue', 'SVP_20', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SVVolume', 'SpeechVoiceSpeakFlags',
    'SpeechCategoryAudioOut', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRCEAudioLevel', 'SVSFDefault',
    'SpeechCategoryPhoneConverters', 'DISPID_SBSWrite',
    'IEnumSpObjectTokens', 'DISPID_SPRText', 'DISPID_SGRsCommit',
    'SPLOADOPTIONS', 'SPSHORTCUTPAIRLIST', 'ISpeechVoiceStatus',
    'SVSFPersistXML', 'STSF_FlagCreate', 'SPWAVEFORMATTYPE',
    'DISPID_SLPLangId', 'ISpeechPhoneConverter',
    'SGLexicalNoSpecialChars', 'SPEI_RESERVED1', 'eLEXTYPE_RESERVED4',
    'DISPID_SPIAudioSizeBytes', 'SDA_Consume_Leading_Spaces',
    'DISPID_SVDisplayUI', 'SGSExclusive', 'DISPID_SRRRecoContext',
    'DISPID_SpeechRecoResult2', 'SPEI_RECO_OTHER_CONTEXT',
    'SGRSTTWildcard', 'ISpEventSource', 'SpeechGrammarWordType',
    'DISPID_SpeechPhraseRules', 'SWPKnownWordPronounceable',
    'DISPID_SVGetProfiles', 'DISPID_SRCCreateGrammar',
    'SVEVoiceChange', 'SAFT24kHz16BitMono',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SpeechVoice',
    'SPPHRASEPROPERTY', 'SRERequestUI', 'SpeechCategoryRecognizers',
    'STCRemoteServer', 'SPXRO_Alternates_SML',
    'DISPID_SPELexicalForm', 'DISPID_SRRAudioFormat',
    'DISPID_SBSSeek', 'SGPronounciation', 'SP_VISEME_21', 'SPPS_LMA',
    'DISPID_SpeechRecoResult', 'SPEI_UNDEFINED',
    'ISpObjectTokenCategory', 'DISPID_SpeechLexiconWord',
    'eLEXTYPE_PRIVATE12', 'ISpeechLexiconWords',
    'ISpPhoneticAlphabetSelection', 'SVSFIsNotXML',
    'DISPID_SPRNumberOfElements', 'SPAO_NONE', 'SREStateChange',
    'SPEI_END_SR_STREAM', 'DISPID_SLGetPronunciations',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPRST_ACTIVE',
    'DISPID_SGRSTsCount', 'tagSPPROPERTYINFO', 'SAFT48kHz16BitStereo',
    'DISPID_SLWLangId', 'SRTEmulated', 'SVF_Stressed',
    'SPPS_RESERVED4', 'SVF_None', 'SPINTERFERENCE_LATENCY_WARNING',
    'SVSFParseMask', 'DISPID_SABIBufferSize',
    'SPEI_PROPERTY_STRING_CHANGE', 'SSSPTRelativeToEnd',
    'DISPID_SRCERecognition', 'DISPID_SGRSTWeight',
    'SDA_One_Trailing_Space', 'SRAInterpreter', 'eLEXTYPE_PRIVATE9',
    'SLODynamic', 'DISPID_SVSPhonemeId', 'DISPID_SpeechGrammarRules',
    'SPGRAMMARSTATE', 'DISPID_SPCLangId', 'ISpRecoContext',
    'DISPID_SVGetAudioOutputs', 'DISPID_SRRTLength',
    'eLEXTYPE_PRIVATE11', 'DISPID_SGRSRule', 'UINT_PTR', 'ISpVoice',
    'SGDisplay', 'DISPID_SpeechVoiceEvent',
    'DISPID_SPEEngineConfidence', 'SpStreamFormatConverter',
    'DISPID_SRRSaveToMemory', 'DISPID_SpeechPhraseProperty',
    'SLTUser', 'SPEI_SR_BOOKMARK', 'ISpeechPhraseRules', 'SRTReSent',
    'ISpeechMemoryStream', 'DISPID_SPEs_NewEnum', 'SPAR_Low',
    'SPXRO_SML', 'STSF_CommonAppData', 'SPEI_START_INPUT_STREAM',
    'SGSDisabled', 'SpeechMicTraining', 'DISPID_SRGCmdLoadFromObject',
    'Speech_StreamPos_Asap', 'SPVPRI_OVER', 'SpeechTokenKeyFiles',
    'SpeechEngineConfidence', 'eWORDTYPE_ADDED', 'SAFT44kHz16BitMono',
    'SRTStandard', 'SREStreamStart', 'SpeechRecognizerState',
    'Speech_StreamPos_RealTime', 'SAFTCCITT_uLaw_11kHzMono',
    'ISpRecoContext2', 'SAFT44kHz16BitStereo', 'SVP_16',
    'DISPID_SGRSTRule', 'DISPID_SPPValue', 'DISPID_SLPSymbolic',
    'DISPID_SpeechRecognizer', 'SVSFNLPMask', 'SVP_7',
    'ISpNotifySink', 'SAFT8kHz8BitStereo', 'DISPID_SPPParent',
    'SVSFParseAutodetect', 'ISpPhoneConverter', 'SDTLexicalForm',
    'SpeechFormatType', 'SpeechDiscardType', 'DISPID_SGRSTText',
    'DISPID_SRRTimes', 'SPEI_SR_PRIVATE', 'ISpRecognizer2',
    'ISpeechPhraseProperty', 'DISPID_SDKOpenKey',
    'SPDKL_LocalMachine', 'DISPID_SLWs_NewEnum',
    'IInternetSecurityManager', 'SPEI_HYPOTHESIS',
    'SAFT11kHz16BitStereo', 'SITooSlow', 'DISPID_SpeechMemoryStream',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpInprocRecognizer',
    'IInternetSecurityMgrSite',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPCT_SUB_DICTATION',
    'ISpRecoCategory', 'DISPID_SGRSTPropertyName',
    'DISPID_SVSInputSentencePosition', 'SPSFunction',
    'DISPID_SLWWord', 'SPAUDIOOPTIONS', 'ISpeechBaseStream',
    'DISPID_SRRSetTextFeedback', 'SPEI_PHRASE_START',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SVPause', 'SDTAudio',
    'DISPID_SpeechFileStream', 'SVSFParseSsml', 'SVSFVoiceMask',
    'SPPS_SuppressWord', 'DISPID_SPISaveToMemory', 'SPSVerb',
    'ISpeechObjectTokens', 'SPEI_RESERVED3', 'DISPID_SRCEAdaptation',
    'SVPOver', 'SPRECOGNIZERSTATUS', 'SPINTERFERENCE_NOSIGNAL',
    'SGLexical', 'SGRSTTEpsilon', 'SWPUnknownWordUnpronounceable',
    'SpeechPropertyAdaptationOn', 'DISPID_SOTRemove',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVEWord',
    'SpeechPropertyNormalConfidenceThreshold', 'SGDSInactive',
    'SpeechPropertyResponseSpeed', 'SECNormalConfidence',
    'SPPS_RESERVED1', 'DISPID_SRCEventInterests',
    'SpeechCategoryVoices', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SVAlertBoundary', 'SAFTCCITT_ALaw_44kHzMono',
    'SPWT_LEXICAL', 'DISPID_SRCESoundStart',
    'DISPID_SRGetRecognizers', 'DISPID_SGRAddState',
    'ISpStreamFormatConverter', 'SPCS_DISABLED',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRCState',
    'SPINTERFERENCE_TOOSLOW', 'SPSTREAMFORMATTYPE',
    'DISPID_SRGetPropertyString', 'SDTDisplayText',
    'DISPID_SMSALineId', 'SPEI_MAX_TTS', 'SpeechTokenShellFolder',
    'SAFT48kHz8BitMono', 'ISpeechVoice', 'SP_VISEME_4',
    'SPPS_Unknown', 'DISPID_SGRId', 'DISPID_SPPId',
    'SpeechVisemeType', 'SpeechRuleState', 'DISPID_SRCRetainedAudio',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRState', 'DISPID_SVRate',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SPPChildren',
    'SPEI_SOUND_START', 'DISPID_SLPType', 'SPSHORTCUTPAIR',
    'SPFM_OPEN_READONLY', 'SSTTWildcard', 'ISpeechPhraseElement',
    'IStream', 'DISPID_SLGetWords', 'SAFT24kHz16BitStereo',
    'SPEI_INTERFERENCE', 'SVP_6', 'DISPID_SLWPronunciations',
    'STCInprocHandler', 'SPSHT_OTHER', 'DISPID_SPIAudioSizeTime',
    'SRSActive', 'SVP_2', 'SPGS_ENABLED', 'SVEAudioLevel',
    'SP_VISEME_18', 'eLEXTYPE_RESERVED10',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SGRAddResource',
    'DISPID_SREmulateRecognition', 'SPEI_SOUND_END',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPPsItem',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SGRSAddSpecialTransition',
    '_ISpeechRecoContextEvents', 'SpPhraseInfoBuilder',
    'SVEStartInputStream', 'DISPID_SOTGetAttribute',
    'ISpeechObjectToken', 'DISPID_SVStatus', 'SAFT16kHz16BitStereo',
    'SAFTTrueSpeech_8kHz1BitMono', 'eLEXTYPE_PRIVATE18',
    'SAFT11kHz8BitStereo', 'DISPID_SPEsCount',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SECLowConfidence',
    'DISPID_SPCIdToPhone', 'DISPID_SRCCmdMaxAlternates',
    'ISpMMSysAudio', 'SSTTTextBuffer', 'SPWORDPRONOUNCEABLE',
    'DISPID_SAStatus', 'ISpDataKey', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SRCEInterference', 'SWTDeleted', 'SPAUDIOBUFFERINFO',
    'DISPID_SDKEnumValues', 'SAFT22kHz8BitStereo',
    'DISPID_SASCurrentSeekPosition', 'ISpNotifyTranslator',
    'SpeechCategoryRecoProfiles', 'eLEXTYPE_PRIVATE16',
    'ISpeechPhraseProperties', 'SpeechVoiceCategoryTTSRate',
    'SPPS_RESERVED2', 'DISPID_SRRPhraseInfo', 'DISPID_SAVolume',
    'DISPID_SVSVisemeId', 'DISPID_SpeechObjectToken',
    'DISPID_SpeechDataKey', 'DISPID_SASNonBlockingIO',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRGDictationSetState',
    'DISPID_SPEsItem', 'DISPID_SASState', 'SpSharedRecoContext',
    'DISPID_SPRuleId', 'SRAORetainAudio',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SAFT22kHz8BitMono',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPILanguageId',
    'SECHighConfidence', 'ISpeechLexiconPronunciation',
    'ISpeechGrammarRuleState', 'eLEXTYPE_RESERVED8',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SLRemovePronunciation',
    'DISPID_SPIStartTime', 'SpSharedRecognizer',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SBSRead',
    'SAFT11kHz8BitMono', 'SAFT32kHz16BitMono', 'eLEXTYPE_PRIVATE15',
    'DISPID_SGRSTPropertyId', 'SDTProperty', 'DISPIDSPTSI',
    'DISPID_SPIProperties', 'SASStop', 'SDKLCurrentConfig',
    'DISPID_SVEStreamEnd', '_RemotableHandle', 'eLEXTYPE_PRIVATE6',
    'ISpObjectToken', 'DISPID_SPANumberOfElementsInResult',
    'SPWT_DISPLAY', 'SPRULESTATE', 'eWORDTYPE_DELETED',
    'DISPID_SOTGetStorageFileName', 'DISPID_SLAddPronunciation',
    'DISPID_SVEVoiceChange', 'SPSUnknown',
    'DISPID_SRGDictationUnload', 'SVEEndInputStream',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPRuleChildren', 'SpMMAudioIn',
    'SpPhoneticAlphabetConverter', 'SpTextSelectionInformation',
    'SPEI_TTS_BOOKMARK', 'DISPID_SpeechMMSysAudio',
    'eLEXTYPE_RESERVED7', 'eLEXTYPE_APP', 'SVP_17', 'SPEVENT',
    'DISPID_SLGenerationId', 'SAFT48kHz16BitMono',
    'SRSInactiveWithPurge', 'DISPID_SVAudioOutput',
    'SVESentenceBoundary', 'DISPID_SRProfile', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SGRsCommitAndSave', 'SpeechDisplayAttributes',
    'ISpeechMMSysAudio', 'ISpeechDataKey',
    'DISPID_SpeechPhraseElements', 'DISPID_SOTCEnumerateTokens',
    'eLEXTYPE_PRIVATE7', 'DISPID_SABIEventBias', 'DISPID_SPRsItem',
    'SP_VISEME_17', 'DISPID_SGRsFindRule', 'DISPID_SpeechAudio',
    'SVSFNLPSpeakPunc', 'SPWF_INPUT',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SP_VISEME_3',
    'SREAllEvents', 'SpeechTokenValueCLSID', 'SRTExtendableParse',
    'DISPID_SpeechAudioStatus', 'DISPID_SDKGetStringValue',
    'DISPID_SDKGetlongValue', 'DISPID_SVSyncronousSpeakTimeout',
    'eLEXTYPE_RESERVED9', 'DISPID_SDKGetBinaryValue',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SpeechRecoResultTimes', 'ISpRecognizer3',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SGRAttributes',
    'DISPID_SRSetPropertyNumber', 'SPBO_PAUSE', 'DISPID_SVResume',
    'SP_VISEME_2', 'SP_VISEME_6', 'SpeechTokenKeyUI', 'SPBO_NONE',
    'SPGS_EXCLUSIVE', 'SPSInterjection', '_SPAUDIOSTATE',
    'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRCERecognitionForOtherContext', 'eLEXTYPE_PRIVATE3',
    'DISPID_SPIGrammarId', 'SRSInactive', 'SP_VISEME_12',
    'SpeechTokenKeyAttributes', 'SpeechWordType',
    'ISpeechWaveFormatEx', 'SPAS_CLOSED', 'SP_VISEME_5',
    'DISPID_SPPFirstElement', 'SASPause', 'SpLexicon',
    'SRERecognition', 'ISpeechRecoContext', 'DISPID_SVVoice',
    'SPSERIALIZEDPHRASE', 'ISpeechPhraseRule', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRGetFormat', 'SRAImport', 'Speech_Max_Pron_Length',
    'SAFT44kHz8BitMono', 'ISpPhrase', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRCERequestUI', 'SPPARTOFSPEECH', 'SPPROPERTYINFO',
    'SAFTADPCM_8kHzMono', 'DISPID_SAFGetWaveFormatEx',
    'ISpRecoResult', 'DISPID_SpeechLexicon', 'ISpShortcut',
    'SAFT8kHz8BitMono', 'SDTAlternates', 'SPWORD',
    'DISPID_SpeechRecoContext', 'DISPID_SOTsItem',
    'DISPID_SRAudioInput', 'ISpGrammarBuilder', 'SREPrivate',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SOTCSetId',
    'SAFTADPCM_8kHzStereo', 'ISpNotifySource', 'DISPID_SPRuleName',
    'DISPID_SPACommit', 'SPSMF_SAPI_PROPERTIES',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechLexiconPronunciations',
    'SpeechRecoProfileProperties', 'SPLEXICONTYPE', 'SPEI_RESERVED5',
    'DISPID_SRSSupportedLanguages', 'DISPID_SpeechAudioFormat',
    'DISPID_SRGDictationLoad', 'ISpRecognizer',
    'DISPID_SAFSetWaveFormatEx', 'SpeechBookmarkOptions',
    'DISPID_SPRules_NewEnum', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SPERequiredConfidence', 'SPRECOSTATE', 'DISPID_SPAsCount',
    'SRESoundEnd', 'DISPID_SGRClear', 'SAFTGSM610_44kHzMono',
    'SAFTCCITT_ALaw_8kHzMono', 'SpeechPartOfSpeech',
    'DISPID_SVEEnginePrivate', 'SRADynamic',
    'ISpeechRecognizerStatus', 'SPBINARYGRAMMAR',
    'DISPID_SPRuleConfidence', 'SGDSActiveUserDelimited',
    'DISPID_SPRsCount', 'DISPID_SGRInitialState', 'SPPS_Noncontent',
    'ISequentialStream', 'SpeechAudioVolume', 'SFTInput',
    'ISpeechRecognizer', 'DISPID_SpeechPhraseElement',
    'DISPID_SFSOpen', 'SPINTERFERENCE_TOOQUIET',
    'ISpeechRecoResultTimes', 'SGRSTTTextBuffer', 'WAVEFORMATEX',
    'SREPropertyStringChange', 'DISPID_SLPPartOfSpeech',
    'SPWT_PRONUNCIATION', 'DISPID_SPAPhraseInfo',
    'SPTEXTSELECTIONINFO', 'SASRun', 'DISPID_SWFEBlockAlign',
    'DISPID_SWFESamplesPerSec', 'SAFT22kHz16BitMono', 'SSFMCreate',
    'SPWF_SRENGINE', 'DISPID_SVSInputSentenceLength',
    'DISPID_SPPEngineConfidence', 'DISPID_SRCreateRecoContext',
    'SPWORDTYPE', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SVEPhoneme', 'SAFT32kHz8BitMono', 'ISpeechAudioStatus',
    'ISpeechTextSelectionInformation', 'DISPID_SLWsItem',
    'ISpeechRecoResult2', 'eLEXTYPE_PRIVATE17', 'ISpProperties',
    'SPCT_SUB_COMMAND', 'DISPID_SRSNumberOfActiveRules',
    'SPPS_Interjection', 'DISPID_SpeechBaseStream', 'SITooLoud',
    'SpeechRecoEvents', 'eLEXTYPE_PRIVATE2', 'DISPID_SGRSTsItem',
    'DISPID_SDKDeleteKey', 'Speech_Max_Word_Length', 'SGDSActive',
    'SPWORDLIST', 'SVEPrivate', 'DISPID_SLPs_NewEnum',
    'SPGS_DISABLED', 'SpeechAudioState', 'DISPID_SVSLastBookmark',
    'SREPropertyNumChange', 'SPAS_RUN', 'DISPID_SPPs_NewEnum',
    'SpeechRegistryUserRoot', 'SDTReplacement', 'DISPID_SVPriority',
    'SECFDefault', 'DISPID_SpeechLexiconProns', 'DISPID_SRIsShared',
    'DISPID_SRGRecoContext', 'IEnumString', 'SP_VISEME_0',
    'SPCT_SLEEP', 'DISPID_SLWsCount', 'SVP_1', 'ISpeechXMLRecoResult',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpeechLexiconType',
    'SpFileStream', 'eLEXTYPE_PRIVATE5', 'ISpeechPhraseInfoBuilder',
    'DISPID_SVSInputWordLength', 'DISPID_SRGCmdSetRuleState',
    'SPSLMA', 'SECFIgnoreKanaType', 'SAFT48kHz8BitStereo',
    'DISPID_SDKSetBinaryValue', 'SVSFParseSapi', 'SP_VISEME_9',
    'SpeechGrammarState', 'DISPID_SVIsUISupported', 'SPSSuppressWord',
    'ISpPhoneticAlphabetConverter', 'SREInterference',
    'SpeechPropertyHighConfidenceThreshold', 'SPINTERFERENCE',
    'SDTAll', 'SVSFlagsAsync', '_ISpeechVoiceEvents', 'SRESoundStart',
    'SPAS_STOP', 'DISPID_SVSpeakStream', 'DISPID_SOTCId',
    'SPEI_ADAPTATION', 'SpeechLoadOption',
    'DISPID_SRCCreateResultFromMemory', 'SpeechPropertyResourceUsage',
    'ISpPhraseAlt', 'SpNotifyTranslator', 'DISPID_SRSAudioStatus',
    'DISPID_SRCEHypothesis', 'ISpResourceManager',
    'DISPID_SpeechGrammarRule', 'DISPID_SGRSTType',
    'DISPID_SRSCurrentStreamPosition', 'SVP_11', 'DISPID_SVSkip',
    'SECFEmulateResult', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRIsUISupported', 'DISPID_SGRSTransitions',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SPPName',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SP_VISEME_10',
    'SPEI_RESERVED6', 'DISPID_SVSpeakCompleteEvent', 'SPEI_MAX_SR',
    'DISPID_SGRsAdd', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SPERetainedSizeBytes', 'SPSNotOverriden',
    'DISPID_SGRsDynamic', 'SINoise', 'DISPID_SOTCategory',
    'SPVPRI_NORMAL', 'STCLocalServer', 'DISPID_SpeechPhoneConverter',
    'SpAudioFormat', 'eLEXTYPE_PRIVATE10', 'SVP_8',
    'DISPID_SpeechLexiconWords', 'DISPID_SRCRecognizer',
    'SREAdaptation', 'SRARoot', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRGSetTextSelection', 'SAFTCCITT_ALaw_44kHzStereo',
    'SP_VISEME_13', 'Speech_Default_Weight', 'DISPID_SWFEChannels',
    'SSTTDictation', 'SpeechAudioProperties', 'SPFILEMODE', 'SVP_5',
    'DISPID_SOTCreateInstance',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SVSLastResult',
    'ISpStream', 'SAFTCCITT_uLaw_22kHzMono', 'SPAR_Unknown',
    'eLEXTYPE_PRIVATE8', 'DISPID_SVEventInterests', 'SVPNormal',
    'SPBOOKMARKOPTIONS', 'ISpeechPhraseAlternates', 'DISPID_SFSClose',
    'DISPID_SpeechCustomStream', 'DISPID_SRGRules', 'SpMMAudioOut',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SGRSAddRuleTransition', 'SPPS_Noun', 'SASClosed',
    'DISPID_SRCEEnginePrivate', 'SpeechRecognitionType',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SOTCGetDataKey', 'SpVoice',
    'SECFIgnoreWidth', 'SPPHRASEREPLACEMENT',
    'DISPID_SDKSetLongValue', 'SPVOICESTATUS', 'eLEXTYPE_PRIVATE14',
    'DISPID_SLPsItem', 'SITooQuiet', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPEI_TTS_PRIVATE', 'SVEAllEvents', 'DISPID_SPIRule', 'SVP_9',
    'DISPID_SpeechGrammarRuleState', 'SLTApp', 'DISPID_SRCEEndStream',
    'SAFTGSM610_8kHzMono', 'DISPID_SPRuleEngineConfidence', 'SVP_0',
    'SPDKL_CurrentConfig', 'SGDSActiveWithAutoPause',
    'DISPID_SVEViseme', 'SpeechVisemeFeature',
    'SAFTCCITT_uLaw_8kHzStereo', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SWFEExtraData', 'SpeechDataKeyLocation',
    'SPPHRASEELEMENT', 'SPPS_RESERVED3', 'SPLO_STATIC',
    'DISPID_SRCRequestedUIType', 'DISPID_SRCERecognizerStateChange',
    'SRSEIsSpeaking', 'SRATopLevel', 'DISPID_SLGetGenerationChange',
    'SPCONTEXTSTATE', 'SREPhraseStart', 'DISPID_SVSInputWordPosition',
    'SAFT16kHz16BitMono', 'SAFT44kHz8BitStereo',
    'DISPID_SRGCmdSetRuleIdState', 'ISpeechPhraseElements',
    'SVSFIsXML', 'DISPID_SASetState', 'ISpeechGrammarRule',
    'DISPID_SpeechObjectTokenCategory', 'SAFTADPCM_22kHzStereo',
    'SP_VISEME_7', 'SPSMF_UPS', 'SPDKL_CurrentUser', 'SPPS_Function',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SPRDisplayAttributes',
    'SpeechRuleAttributes', 'SPINTERFERENCE_NOISE',
    'DISPID_SABufferInfo', 'SLOStatic',
    'SpeechStreamSeekPositionType', 'SRCS_Enabled', 'SVEViseme',
    'DISPID_SPEDisplayText', 'eLEXTYPE_LETTERTOSOUND',
    'SAFTGSM610_11kHzMono', 'SPVPRIORITY', 'ISpeechAudioFormat',
    'SGSEnabled', 'DISPID_SPCPhoneToId', 'DISPID_SGRs_NewEnum',
    'DISPID_SPAs_NewEnum', 'SGRSTTWord', 'SREBookmark',
    'DISPID_SPRuleNumberOfElements', '__MIDL_IWinTypes_0009',
    'SPEI_START_SR_STREAM', 'SPDKL_DefaultLocation', 'SPRST_INACTIVE',
    'ISpeechCustomStream', 'SPFM_OPEN_READWRITE',
    'DISPID_SGRSTNextState', 'tagSPTEXTSELECTIONINFO',
    'ISpeechLexicon', 'eLEXTYPE_USER_SHORTCUT', 'SAFT32kHz8BitStereo',
    'DISPID_SRGReset', 'SAFTADPCM_22kHzMono', 'DISPID_SPRulesCount',
    'SP_VISEME_11', 'DISPID_SVGetAudioInputs', 'SAFT8kHz16BitStereo',
    'SpeechCategoryAppLexicons', 'SPPS_Modifier', 'SPAUDIOSTATE',
    'DISPID_SMSGetData', 'DISPID_SpeechPhraseReplacement',
    'SPEI_MIN_TTS', 'DISPID_SVESentenceBoundary',
    'SPFM_CREATE_ALWAYS', 'SDKLCurrentUser', 'STCInprocServer',
    'DISPID_SRCResume', 'SPSHT_Unknown', 'DISPID_SGRsItem',
    'SpeechRunState', 'ISpeechGrammarRules', 'ISpSerializeState',
    'SPAO_RETAIN_AUDIO', 'SpeechAudioFormatGUIDText',
    'DISPID_SPIEngineId', 'SPEI_WORD_BOUNDARY',
    'SPADAPTATIONRELEVANCE', 'SpeechInterference', 'ISpeechAudio',
    'DISPID_SABufferNotifySize', 'DISPID_SAFType',
    'SpeechUserTraining', 'DISPID_SRGId', 'SPCT_DICTATION',
    'SSFMOpenReadWrite', 'DISPID_SPIGetText', 'SpeechTokenContext',
    'DISPID_SPRFirstElement', 'SSFMCreateForWrite',
    'ISpeechRecoResultDispatch', 'SPFM_NUM_MODES',
    'DISPID_SRRGetXMLErrorInfo', 'SPVISEMES',
    'DISPID_SVSRunningState', 'DISPID_SVSpeak', 'SVEWordBoundary',
    'SPSHORTCUTTYPE', 'DISPID_SRRTStreamTime', 'DISPID_SOTsCount',
    'SVPAlert', 'DISPID_SRGCommit', 'SpeechGrammarTagWildcard',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechRecognizerStatus', 'ISpObjectWithToken',
    'SP_VISEME_16', 'SpeechAudioFormatType',
    'DISPID_SGRSAddWordTransition', 'SpeechDictationTopicSpelling'
]

_check_version('1.2.0', 1700032066.769035)
